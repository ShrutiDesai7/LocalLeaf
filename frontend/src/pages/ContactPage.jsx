    ...
    <section className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="grid gap-8 lg:grid-cols-[1fr_0.95fr]">
        <div className="rounded-[36px] bg-leaf-forest px-6 py-10 text-white shadow-card sm:px-8">
          <p className="text-sm uppercase tracking-[0.26em] text-white/65">Help / Support</p>
        ...
        <div className="glass-panel p-6 sm:p-10">
          ...
          <div className="mt-6 space-y-4">
            <div className="rounded-[24px] bg-white/70 p-6">
              <p className="text-sm uppercase tracking-[0.22em] text-leaf-moss">Email</p>
            ...
            <div className="rounded-[24px] bg-white/70 p-6">
              <p className="text-sm uppercase tracking-[0.22em] text-leaf-moss">Business hours</p>
              <p className="mt-2 text-sm leading-6 text-leaf-moss">
